...
CFLAGS = -DMSHADOW_FORCE_STREAM $(WARNFLAGS) -lrt
...
# setup opencv
ifeq ($(USE_OPENCV), 1)
	CFLAGS += -DMXNET_USE_OPENCV=1 -I/admin/build/rpms/maverick/BUILD/mxnet/opencv/include
	LDFLAGS += -L/admin/build/rpms/maverick/BUILD/mxnet/opencv/lib -lopencv_calib3d -lopencv_contrib -lopencv_core -lopencv_features2d -lopencv_flann -lopencv_gpu -lopencv_highgui -lopencv_imgproc -lopencv_legacy -lopencv_ml -lopencv_nonfree -lopencv_objdetect -lopencv_ocl -lopencv_photo -lopencv_stitching -lopencv_superres -lopencv_ts -lopencv_video -lopencv_videostab
	BIN += bin/im2rec
else
...
ifeq ($(USE_CUDNN), 1)
	CFLAGS += -DMSHADOW_USE_CUDNN=1 -I/opt/apps/cuda8_0/cudnn/5.1/include
	LDFLAGS +=  -lcudnn -L/opt/apps/cuda8_0/cudnn/5.1/lib64
endif
